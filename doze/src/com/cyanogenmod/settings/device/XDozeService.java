...
public class XDozeService extends Service {
    private static final String TAG = "XDozeService";
    ...
    class XProximitySensor implements SensorEventListener {
        ...
        public XProximitySensor(Context context) {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "XDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new XProximitySensor(mContext);
